...
<div class="container">
    <div class="row">
    <h1 class="center">Memorias DDR3</h1>
      <hr>
        <div class="col-md-7 col-md-offset-1">
          <?php
              ...
              $sql = "SELECT * FROM producto WHERE id_subcategoria = 301 LIMIT " . $inicio . "," . $TAMANO_PAGINA;
              $resultado = mysqli_query($con, $sql);
          ?>
                <table class="table table-striped">
                    ...
                    for ($i=1; $i<=$total_paginas; $i++) {
                      ...
                      if ($i == $pagina) {
                        echo "<li class="."active"."><a href='memorias-ddr3.php?pagina=".$i."'>".$i."</a></li> ";
                      }
                      else {
                        echo "<li><a href='memorias-ddr3.php?pagina=".$i."'>".$i."</a></li> ";
                      }
                    } ?>
                      </ul>
                    </div>
